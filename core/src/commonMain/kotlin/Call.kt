 ...
 * 
 * When sent: In response to a commonMain.kotlin.JoinCall when initiating a connection with another user.
 * 
 ...
 * 
 * When sent: After receiving and processing a commonMain.kotlin.PickUpCall with an SDP offer.
 * 
